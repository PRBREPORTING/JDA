"C:\Program Files (x86)\Microsoft SQL Server\150\DTS\Binn\DTExec.exe" /file "C:\Users\abedi\Desktop\SSIS_Local\JDA_Test\bin\Development\FCstPerfStatic_Incremental.dtsx" /config "C:\Users\abedi\Desktop\SSIS_Local\JDA_Test\JDA_PackageDeployment_Config.dtsConfig"
